...
export const tables = {
  ...
  uiState: State.SQLite.clientDocument({
    ...
    default: {
      id: SessionIdSymbol,
      value: { newTodoText: "", filter: "all", description: "text" }, // description default value set
    },
  }),
  uiStateNotSet: State.SQLite.clientDocument({
    name: "uiStateNotSet",
    schema: Schema.Struct({
      newTodoText: Schema.String,
      description: Schema.optional(Schema.String),
    ...
    default: {
      id: SessionIdSymbol,
      value: { newTodoText: "", filter: "all" }, // description default value not set
    },
  }),
};
...
export const events = {
  ...
  uiStateNotSetSet: tables.uiStateNotSet.set,
};
